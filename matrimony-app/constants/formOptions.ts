...
export const formOptionLists: Record<FormOptionsKey, FormOption[]> = {
  ...
  degreeDetail: [
    opt('high-school', 'Secondary School Leaving Certificate (SSLC)', 'இடைநிலைப் பள்ளி சான்றிதழ் (SSLC)'),
    opt('hsc', 'Higher Secondary Certificate (HSC)', 'உயர்நிலைச் சான்றிதழ் (HSC)'),
    opt('iti', 'Industrial Training Institute (ITI)', 'தொழில்பயிற்சி நிறுவனம் (ITI)'),
    opt('diploma', 'Diploma', 'டிப்ளோமா'),
    opt('be-cse', 'B.E Computer Science and Engineering', 'B.E கணினி அறிவியல் மற்றும் பொறியியல்'),
    opt('be-ece', 'B.E Electronics and Communication Engineering', 'B.E மின்னணுவியல் மற்றும் தகவல்தொடர்பு பொறியியல்'),
    opt('be-eee', 'B.E Electrical and Electronics Engineering', 'B.E மின்னியல் மற்றும் மின்னணுவியல் பொறியியல்'),
    opt('be-mechanical', 'B.E Mechanical Engineering', 'B.E இயந்திர பொறியியல்'),
    opt('be-civil', 'B.E Civil Engineering', 'B.E சிவில் பொறியியல்'),
    opt('be-it', 'B.E Information Technology', 'B.E தகவல் தொழில்நுட்பம்'),
    opt('be-auto', 'B.E Automobile Engineering', 'B.E ஆட்டோமொபைல் பொறியியல்'),
    opt('be-biomedical', 'B.E Biomedical Engineering', 'B.E உயிர்மருத்துப் பொறியியல்'),
    opt('be-aero', 'B.E Aeronautical Engineering', 'B.E விமான பொறியியல்'),
    opt('be-chemical', 'B.E Chemical Engineering', 'B.E வேதியியல் பொறியியல்'),
    opt('be', 'B.E (Other Branch)', 'B.E (பிற துறை)'),
    opt('btech-cse', 'B.Tech Computer Science and Engineering', 'B.Tech கணினி அறிவியல் மற்றும் பொறியியல்'),
    opt('btech-ece', 'B.Tech Electronics and Communication Engineering', 'B.Tech மின்னணுவியல் மற்றும் தகவல்தொடர்பு பொறியியல்'),
    opt('btech-eee', 'B.Tech Electrical and Electronics Engineering', 'B.Tech மின்னியல் மற்றும் மின்னணுவியல் பொறியியல்'),
    opt('btech-mechanical', 'B.Tech Mechanical Engineering', 'B.Tech இயந்திர பொறியியல்'),
    opt('btech-civil', 'B.Tech Civil Engineering', 'B.Tech சிவில் பொறியியல்'),
    opt('btech-it', 'B.Tech Information Technology', 'B.Tech தகவல் தொழில்நுட்பம்'),
    opt('btech', 'B.Tech (Other Branch)', 'B.Tech (பிற துறை)'),
    opt('bsc-cs', 'B.Sc Computer Science', 'B.Sc கணினி அறிவியல்'),
    opt('bsc-it', 'B.Sc Information Technology', 'B.Sc தகவல் தொழில்நுட்பம்'),
    opt('bsc-maths', 'B.Sc Mathematics', 'B.Sc கணிதம்'),
    opt('bsc-physics', 'B.Sc Physics', 'B.Sc இயற்பியல்'),
    opt('bsc-chemistry', 'B.Sc Chemistry', 'B.Sc வேதியியல்'),
    opt('bsc-botany', 'B.Sc Botany', 'B.Sc தாவரவியல்'),
    opt('bsc-zoology', 'B.Sc Zoology', 'B.Sc விலங்கியல்'),
    opt('bsc-nursing', 'B.Sc Nursing', 'B.Sc செவிலியர்'),
    opt('bsc-agriculture', 'B.Sc Agriculture', 'B.Sc வேளாண்மை'),
    opt('bsc', 'B.Sc (Other Subject)', 'B.Sc (பிற பாடம்)'),
    opt('barch', 'B.Arch Architecture', 'B.Arch கட்டிடக்கலை'),
    opt('bcom', 'B.Com Commerce', 'B.Com வணிகம்'),
    opt('ba', 'B.A Arts', 'B.A கலை'),
    opt('bba', 'BBA Business Administration', 'BBA வணிக நிர்வாகம்'),
    opt('bca', 'BCA Computer Applications', 'BCA கணினி பயன்பாடுகள்'),
    opt('bpharm', 'B.Pharm Pharmacy', 'B.Pharm மருந்தியல்'),
    opt('bed', 'B.Ed Education', 'B.Ed கல்வி'),
    opt('llb', 'LLB Law', 'LLB சட்டம்'),
    opt('mbbs', 'MBBS Medicine', 'MBBS மருத்துவம்'),
    opt('bds', 'BDS Dental Surgery', 'BDS பல் மருத்துவம்'),
    opt('bams', 'BAMS Ayurvedic Medicine', 'BAMS ஆயுர்வேத மருத்துவம்'),
    opt('bhms', 'BHMS Homeopathic Medicine', 'BHMS ஹோமியோபதி மருத்துவம்'),
    opt('bachelors', "Bachelor's Degree (Other)", 'இளங்கலை பட்டம் (பிற)'),
    opt('me-cse', 'M.E Computer Science and Engineering', 'M.E கணினி அறிவியல் மற்றும் பொறியியல்'),
    opt('me-ece', 'M.E Electronics and Communication Engineering', 'M.E மின்னணுவியல் மற்றும் தகவல்தொடர்பு பொறியியல்'),
    opt('me', 'M.E (Other Branch)', 'M.E (பிற துறை)'),
    opt('mtech-cse', 'M.Tech Computer Science and Engineering', 'M.Tech கணினி அறிவியல் மற்றும் பொறியியல்'),
    opt('mtech-ece', 'M.Tech Electronics and Communication Engineering', 'M.Tech மின்னணுவியல் மற்றும் தகவல்தொடர்பு பொறியியல்'),
    opt('mtech', 'M.Tech (Other Branch)', 'M.Tech (பிற துறை)'),
    opt('msc-cs', 'M.Sc Computer Science', 'M.Sc கணினி அறிவியல்'),
    opt('msc-it', 'M.Sc Information Technology', 'M.Sc தகவல் தொழில்நுட்பம்'),
    opt('msc-maths', 'M.Sc Mathematics', 'M.Sc கணிதம்'),
    opt('msc-physics', 'M.Sc Physics', 'M.Sc இயற்பியல்'),
    opt('msc-chemistry', 'M.Sc Chemistry', 'M.Sc வேதியியல்'),
    opt('msc', 'M.Sc (Other Subject)', 'M.Sc (பிற பாடம்)'),
    opt('mcom', 'M.Com Commerce', 'M.Com வணிகம்'),
    opt('ma', 'M.A Arts', 'M.A கலை'),
    opt('mba', 'MBA Business Administration', 'MBA வணிக நிர்வாகம்'),
    opt('mca', 'MCA Computer Applications', 'MCA கணினி பயன்பாடுகள்'),
    opt('md', 'MD Doctor of Medicine', 'MD மருத்துவ முனைவர்'),
    opt('ms', 'MS Master of Surgery', 'MS அறுவை சிகிச்சை முதுகலை'),
    opt('masters', "Master's Degree (Other)", 'முதுகலை பட்டம் (பிற)'),
    opt('mphil', 'M.Phil', 'M.Phil'),
    opt('phd', 'Ph.D', 'Ph.D'),
    opt('doctorate', 'Doctorate / PhD', 'முனைவர் பட்டம் / PhD'),
    opt('ca', 'Chartered Accountant (CA)', 'சார்ட்டர் கணக்காளர் (CA)'),
    opt('cma', 'Cost and Management Accountant (CMA)', 'செலவு மற்றும் நிர்வாக கணக்காளர் (CMA)'),
    opt('cs', 'Company Secretary (CS)', 'நிறுவன செயலாளர் (CS)'),
    opt('other', 'Other Professional Qualification', 'பிற தொழில்முறை தகுதி'),
  ],
  religion: [
  ...
  maritalStatusBiodata: [
    ...
    opt('divorced', 'Divorced', 'விவாகரத்து'),
  ],
  livingStatus: [
